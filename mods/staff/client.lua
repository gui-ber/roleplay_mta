function proAtive()
	if getElementData(localPlayer, "pro") then
		outputChatBox("[INFO]:#FFFFFF O dano recebido foi cancelado pois você esta com a invencibilidade ativa (/pro)", 30, 144, 255, true)
		cancelEvent()
	end
end
addEventHandler("onClientPlayerDamage", localPlayer, proAtive)
